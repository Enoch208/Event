...
const sendMessageOnJoiningGroup = async (group, client) => {
const groupMetadatat = await client.groupMetadata(group.id)
  console.log(`${chalk.blueBright('JOINED')} ${chalk.cyanBright(groupMetadatat.subject)}`);
  return await client.sendMessage(group.id, {
